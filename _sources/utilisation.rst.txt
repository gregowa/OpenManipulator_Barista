...
2. Reconstruire l'espace de travail depuis le dossier catkin_ws :  catkin\_make \\ clean
    catkin_make} 
3. item Source devel/setup.bash : recharge l'espace de travail et permet d'éxecuter la commande (à exécuter depuis catkin_ws, à faire à chaque fois que l'on lance un nouveau noeud ROS).
